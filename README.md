...
- FAISS: Fast, scalable nearest-neighbor search
...
- CLIP model and FAISS index are cached in memory
- Modular design supports batch processing and APIs

---

## Future Work

- Batch upload and reporting
- REST API (FastAPI)
